...
const bookingProcessAlias = 'preauth-unit-booking/release-1';
...
const siteTitle = 'AutoMarketplace NYC';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '@automarket_nyc';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = "https://www.instagram.com/automarketplace_nyc/";
const siteLinkedinPage = "https://www.linkedin.com/company/automarketplace";
const siteYoutubePage = "https://www.youtube.com/channel/UCBLspAbS3IQu-w9QaEaVyQg";

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/AutoMarketplaceNYC';
