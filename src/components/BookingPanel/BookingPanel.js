...
const BookingPanel = props => {
  ...
  const category = listing && listing.attributes && listing.attributes.publicData &&
    ...
    <div className={classes}>
      ...
      >
        ...
        <div className={css.bookingHeading}>
          ...
          {subTitleText && (isHourlyListingType || isDailyListingType)? <div className={css.bookingHelp}>{subTitleText}</div> : null}
        </div>
      ...
      <div className={css.openBookingForm}>
        ...
        {showBookingDatesForm ? (
          ...
          >
            <FormattedMessage id={isUnitListingType ? 'BookingPanel.ctaBuyButtonMessage' : 'BookingPanel.ctaButtonMessage'} />
          </Button>
        ) : isClosed ? (
