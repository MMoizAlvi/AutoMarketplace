...
export const BookingBreakdownComponent = props => {
  ...
  const categoryValue = publicData && listing.attributes.publicData.category;
  const priceUnit = publicData && listing.attributes.publicData.priceUnit;
