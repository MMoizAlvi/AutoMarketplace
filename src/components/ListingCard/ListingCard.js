...
export const ListingCardComponent = props => {
  const { className, rootClassName, intl, listing, renderSizes, setActiveListing, totalRating } = props;
  ...
  const { priceUnit, category, location, cityState} = publicData;
        ...
        <div className={css.mainInfo}>
          ...
          <div className={css.authorContainer}>
            <div className={css.authorInfo}>
                <FormattedMessage id="ListingCard.hostedBy"/>
                {authorName}
            </div>
