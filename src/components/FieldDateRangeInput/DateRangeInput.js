...
class DateRangeInputComponent extends Component {
  ...
  onDatesChange(dates) {
    ...
    const endDate = dates.endDate ? dates.endDate : moment(startDate);
  ...
  render() {
    ...
    const hideEndDateClass = hideEndDate ? css.hideEndDate : null; 
    
    const classes = classNames(css.inputRoot, className, hideEndDateClass, {
