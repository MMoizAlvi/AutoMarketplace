...
const EditListingWizardTab = props => {
  ...
  const isGuideListing = config.custom.SCHEDULING_LISTING_TYPES.includes(category)
  ...
  switch (tab) {
    ...
    case LOCATION: {
      const submitButtonTranslationKey = isNewListingFlow
        ? isGuideListing ? 'EditListingWizard.saveNewAvailability' : 'EditListingWizard.saveNewLocation'
