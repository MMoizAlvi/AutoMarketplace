    ...
    case HEADING_REQUESTED:
      return isCustomer ? (
        <HeadingCustomerWithSubtitle
          ...
          values={{ customerName }}
          subtitleId={ isUnit ? "TransactionPanel.orderUnitPreauthorizedSubtitle" : "TransactionPanel.orderPreauthorizedSubtitle" }
          subtitleValues={{ listingLink }}
        >
          {!listingDeleted ? (
            <p className={css.transactionInfoMessage}>
              <FormattedMessage
                id={ isUnit ? "TransactionPanel.orderUnitPreauthorizedInfo" : "TransactionPanel.orderPreauthorizedInfo" }
                values={{ providerName }}
              />
            </p>
          ) : null}
    ...
    case HEADING_ACCEPTED:
      return isCustomer ? (
        <HeadingCustomerWithSubtitle
          ...
          id="TransactionPanel.orderPreauthorizedTitle"
          values={{ customerName }}
          subtitleId={ isUnit ? "TransactionPanel.orderUnitAcceptedSubtitle" : "TransactionPanel.orderAcceptedSubtitle" }
          subtitleValues={{ listingLink }}
        />
      ) : (
        <HeadingProvider
