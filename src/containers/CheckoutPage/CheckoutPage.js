...
export class CheckoutPageComponent extends Component {
      ...
      fetchSpeculatedTransaction(
        {
          ...
          quantity: (bookingData && bookingData.quantity) || pageData.bookingData.quantity,
          isUnit
        },
        transactionId
      );
  ...
  render() {
    ...
    const bookingUnitType =  isUnit ? "line-item/units" : config.bookingUnitType 
    const breakdown =
      tx.id && txBooking.id ? (
        <BookingBreakdown
    ...
    const unitType = bookingUnitType;
