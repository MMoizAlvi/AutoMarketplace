...
export { default as UserOwnershipPage } from './UserOwnershipPage/UserOwnershipPage';
export { default as AutomktRewards } from './AutomktRewardsPage/AutomktRewardsPage';
export { default as BlockchainPage } from './BlockchainPage/BlockchainPage';
export { default as CurrentOffersPage } from './CurrentOffersPage/CurrentOffersPage';
export { default as MaintenancePlansPage } from './MaintenancePlansPage/MaintenancePlansPage';
export { default as EarningAUTOMKTTokenPage } from './EarningAUTOMKTTokenPage/EarningAUTOMKTTokenPage';
export { default as HowItWorksPage } from './HowItWorksPage/HowItWorksPage';
export { default as BNPLPage } from './BNPLPage/BNPLPage';
export { default as Web3MarketplacePage } from './Web3MarketplacePage/Web3MarketplacePage';
export { default as ElectricVehiclePage } from './ElectricVehiclePage/ElectricVehiclePage';
