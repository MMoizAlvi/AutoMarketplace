...
const routeConfiguration = () => {
  return [
    ...
    },
    {
      ...
      name: 'ManageYourMaintenance',
      component: MaintenancePlansPage,
    },
    {
      path: '/user_ownership',
      name: 'UserOwnershipPage',
      component: UserOwnershipPage,
    },
    {
      path: '/web3_marketplace',
      name: 'Web3MarketplacePage',
      component: Web3MarketplacePage,
    },
    {
      path: '/BNPLPage',
      name: 'BNPLPage',
    ...
    {
      path: '/Electric_Vehicle',
      name: 'ElectricVehicle',
      component: ElectricVehiclePage,
    },
    {
      path: '/how_it_works',
      name: 'HowItWorks',
    ...
    {
      path: '/automkt_rewards',
      name: 'AutomktRewards',
      component: AutomktRewards,
    },
    {
      path: '/blockchain',
      name: 'BlockchainPage',
    ...
    {
      path: '/earning_automkt_token',
      name: 'EarningAUTOMKTTokenPage',
      component: EarningAUTOMKTTokenPage,
    },
    {
      path: '/current_offers',
