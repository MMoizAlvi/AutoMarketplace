...
import { nonEmptyArray, composeValidators, minLength } from '../../util/validators';
    ...
    return (
      <FinalForm
        ...
        render={formRenderProps => {
          ...
          const threeImagesRequiredMessage = intl.formatMessage({
            id: 'EditListingPhotosForm.threeImagesRequiredMessage',
          });
          ...
          const dropzoneRootProps = omit( {...getRootProps()}, 'onChange', 'onClick' )
          const dropzoneInputProps =  omit( {...getInputProps()}, 'onChange', 'onClick')
              ...
              >
                ...
                >
                  {fieldprops => {
                    ...
                    return (
                      <div className={css.addImageWrapper} {...dropzoneRootProps}>
                        <div className={css.aspectRatioWrapper} >
                          {fieldDisabled ? null : (
                            <input {...inputProps} className={css.addImageInput} {...getInputProps()}/>
                          )}
                ...
                <Field
                  ...
                  name="images"
                  type="hidden"
                  validate={composeValidators(nonEmptyArray(imageRequiredMessage), minLength(threeImagesRequiredMessage, 3))}
                />
              </AddImages>
              {uploadImageFailed}

              <p className={css.tip}>
                <FormattedMessage id="EditListingPhotosForm.addImagesTip" /> <br />
                <FormattedMessage id="EditListingPhotosForm.imagesSizeTip" />
              </p>
